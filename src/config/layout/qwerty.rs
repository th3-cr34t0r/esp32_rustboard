...
//
//X \ Y|  0  |  1  |  2  |  3  |  4  |  5  |           X \ Y|  6  |  7  |  8  |  9  |  10 |  11 |
//   0 |_ESC_|_____|__7__|__8__|__9__|_PScr|              0 |_SLCK|__(__|__)__|__=__|__/__|_____|
//   1 |_BSP_|_____|__4__|__5__|__6__|_DEL_|              1 |__-__|_left|_down|__up_|right|_____|
//   2 |_CTL_|__0__|__1__|__2__|__3__|_SUP_|              2 |__\__|_____|_____|__`__|__;__|_____|
//   3                   |_ALT_|_SPC_|_SFT_|              3 |_TAB_|_ENT_|_LYR_|
//
//*********************************************************************************************
#[rustfmt::skip]
    ...
    Layout { keymap:
        [
            ...
            [
                ...
                /*                 +--------------+----------------------------+--------------+-------------+--------------+        +-------------+--------------+-------------+-------------+--------------+------------+*/
                /*   ROW 0  */  [/*|*/Kc::Esc,  /*|*/Kc::Undf, /*|*/Kc::N7,  /*|*/Kc::N8,   /*|*/Kc::N9,  /*|*/Kc::Pscr, /*|        |*/Kc::MaSL,/*|*/Kc::MaLP, /*|*/Kc::MaRP,/*|*/Kc::Eq,  /*|*/Kc::Fsl,  /*|*/Kc::Undf/*|*/],
                /*                 +--------------+----------------------------+--------------+-------------+--------------+        +-------------+--------------+-------------+-------------+--------------+------------+*/
                /*   ROW 1  */  [/*|*/Kc::Bksp, /*|*/Kc::Undf, /*|*/Kc::N4,  /*|*/Kc::N5,   /*|*/Kc::N6,  /*|*/Kc::Del,  /*|        |*/Kc::Mns,/*|*/Kc::ArL,  /*|*/Kc::ArD, /*|*/Kc::ArU,  /*|*/Kc::ArR,  /*|*/Kc::Undf/*|*/],
                /*                 +--------------+--------------+-------------+--------------+-------------+--------------+        +-------------+--------------+-------------+-------------+--------------+------------+*/
                /*   ROW 2  */  [/*|*/Kc::ModCo,/*|*/Kc::N0,   /*|*/Kc::N1,  /*|*/Kc::N2,   /*|*/Kc::N3,  /*|*/Kc::ModSu,/*|        |*/Kc::Bksl,/*|*/Kc::Lbrk, /*|*/Kc::Rbrk,/*|*/Kc::Grav, /*|*/Kc::Scn, /*|*/Kc::Undf/*|*/],
                /*                 +--------------+--------------+-------------+--------------+-------------+--------------+        +-------------+--------------+-------------+-------------+--------------+------------+*/
                /*   ROW 3  */  [/*|*/Kc::Undf, /*|*/Kc::Undf, /*|*/Kc::Undf,/*|*/Kc::ModAl,/*|*/Kc::Spac,/*|*/Kc::ModSh,/*|        |*/Kc::Tab, /*|*/Kc::Entr, /*|*/Kc::L1,  /*|*/Kc::Undf,/*|*/Kc::Undf, /*|*/Kc::Undf/*|*/],
                /*                 +--------------+--------------+-------------+--------------+-------------+--------------+        +-------------+--------------+-------------+-------------+--------------+------------+*/
            ],
